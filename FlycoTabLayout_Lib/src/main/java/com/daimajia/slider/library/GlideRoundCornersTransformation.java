...
import static com.daimajia.slider.library.GlideRoundCornersTransformation.CornerType.ALL;
 ...
 * dzx
 */
public class GlideRoundCornersTransformation implements Transformation<Bitmap> {
    ...
    public GlideRoundCornersTransformation(Context context, int radius, CornerType type) {
